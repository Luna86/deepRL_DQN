...
def main():  # noqa: D103
    ...
    parser.add_argument('--target_update_freq', default=1000, type=int, help='interval between two updates of the target network')
    ...
    agent = DQNAgent(q_network=model, preprocessor=preprocessor, memory=None, policy=policy, gamma=args.gamma, target_update_freq=args.target_update_freq,
                     num_burn_in=args.num_burn_in, train_freq=args.train_freq, batch_size=args.batch_size, env_name=args.env)
